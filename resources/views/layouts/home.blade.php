    ...
    <div class="px-4 py-5 my-5 text-center w-100">
        ...
        <div class="col-lg-6 mx-auto">
            <div>
                ...
                <p class="lead mb-4">
                    Leken går ut på att alla har har ett mål som man ska kulla. Du kullar ditt mål genom att lägga handen på dens axel och säga kull. Sedan ska du scanna personens QR-kod för att få poäng. När du taggar någon så ärver du den personens mål medans ditt mål är ute ur spelet.
                </p>
                ...
                <ul class="text-start">
                    ...
                    <li class="lead text-start">Försök att inte ko-vakta en lektionssal där ditt mål är. Det är helt ärligt skit tråkigt</li>
                ...
                <p class="lead mb-4">Personen som klarar sig längst och personen som taggar flest mål vinner. Priset består av heder och lite SSIS merch från elevrådet.</p>
            </div>
        </div>
    </div>
